...
public partial class Menu : Form
{
    ...
    private void MakeTrainingTalks()
    {
        TrainingTalks = new()
        {
            ...
            "Скорее всего, ты сможешь обогнать только 1 человека за гонку, но твоя стартовая позиция в таком случае в следующей гонке изменится" +
            "и ты уже не будешь заново обгонять того, кого уже хотя бы раз обогнал.",
