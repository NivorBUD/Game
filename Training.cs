...
public partial class Menu : Form
{
    ...
    private void MakeTrainingTalks()
    {
        TrainingTalks = new()
        {
            ...
            "Следующее, про что хотелось бы тебе рассказать - DRS." +
            ...
            "Кстати, когда тебя кто-то будет обгонять, то DRS тебе очень понадобится, " +
            "если ты его потратишь до этого, то ты, скорее всего, не сможешь противостоять обгону",
            ...
            "Скорее всего, ты сможешь обогнать только 1 противника за гонку, но твоя стартовая позиция в случае, когда ты финишируешь раньше него, " +
            "в следующей гонке изменится и ты уже не будешь заново обгонять того, кого уже хотя бы раз обогнал.",

            "Если тебя кто-то обгонит, то ты не потеряешь свое место на стартовой решетке, так как, скорее всего, в следующей же гонке ты вернешь свое место.",

            "Изначально у тебя будет 100$, это от меня, не благодари.",

            "И так, в целом, ты готов, пора внести пару обновлений в болид и начать заезд.",
        };
    }
}